...
![train_val_metrics](./src/results/train_val_metrics.png)
...
![val_metrics_vs_trees](./src/results/val_metrics_vs_trees.png)
...
### 3. Confusion Matrix
![validation_confusion_matrix](./src/results/validation_confusion_matrix.png)
![test_confusion_matrix](./src/results/test_confusion_matrix.png)
...
![Feature Importance](./src/results/feature_importance.png)
- Shows relative importance of each SMART attribute  
- Helps identify which metrics are most predictive  

## Expected Output
![Output_Terminal](./src/results/Output_Terminal.png)
```
